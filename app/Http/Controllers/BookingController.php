...
class BookingController extends Controller
{
    ...
    public function paymentReceiptImage(Request $request, $id)
    {
        ...
        public function exportpdf(){
            ...
            $pdf = PDF::loadview('BookingDetailsPage');
           return $pdf->download('Data.Booking');
        }
        public function deleteBooking($id)
{
    ...
    return redirect()->route('admin.showOneUserBookingDataAll')->with('success', 'Booking successfully deleted!');
}

    public function viewPDF(){
        $pdf = PDF::loadView('<h1>Hello</h1>');
        return $pdf->stream('');
    }
