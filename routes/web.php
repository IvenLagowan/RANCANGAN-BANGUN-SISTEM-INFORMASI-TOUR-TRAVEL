...
Route::middleware('auth')->group(function () {
    ...
    Route::delete('/admin/booking/{id}', [AdminController::class, 'deleteBooking'])->name('admin.showOneUserBookingDataAll');
    Route::get('/view-pdf',  [BookingController::class, 'viewPDF'])->name('view-pdf');
});
